...
### 🔄 Система миграции существующих проектов

Теперь фреймворк поддерживает **автоматическую миграцию legacy проектов**!
...
```bash
# 1. Скопируйте Init/ в свой проект
