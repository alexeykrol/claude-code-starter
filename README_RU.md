...
start
# AI проанализирует ваш проект и поведет вас дальше
```

**Вот и всё!** AI сам определит состояние проекта и предложит нужные действия.

---

## 🔄 Для существующих проектов

> **Уже есть проект с кодом и разрозненной документацией?**

Процесс установки **точно такой же**:
1. Скопируйте `init-starter.zip` и `init-project.sh` в корень проекта
2. Выполните `bash init-project.sh`
3. Запустите `claude` и введите `start`

**AI автоматически проведет вас через миграцию!**
