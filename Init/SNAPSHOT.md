...
> 📋 **Процесс обновления этого файла:** см. [`CLAUDE.md`](./CLAUDE.md)
>
...
### Важные документы:
- `CLAUDE.md` — процесс обновления метафайлов после каждой фазы
- `BACKLOG.md` — детальный план задач (обновляется после каждой фазы)
- `CLAUDE.md` — контекст проекта для AI
- `SNAPSHOT.md` — этот файл, снапшот текущего состояния
...
*Обновляй после каждой фазы согласно CLAUDE.md!*
