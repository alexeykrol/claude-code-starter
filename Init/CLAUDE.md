...
2. ✅ **Проактивно прочитай ключевые файлы:**
   - `PROJECT_INTAKE.md` - требования проекта (если нет - предложи создать)
   - `BACKLOG.md` - статус реализации (если нет - предложи создать)
   - `SECURITY.md` - правила безопасности (если нет - используй шаблон из Init/)

3. ✅ **Начни интерактивный анализ:**
   - Кратко опиши что понял о проекте (1-2 абзаца)
   - Выяви пробелы в документации
   - Задай 3-5 уточняющих вопросов для понимания контекста

4. ✅ **Предложи следующие шаги:**
   - Что нужно заполнить/дополнить в документации
   - Какие задачи можно начать
