...
5. **Документирование по ходу** — обновлять BACKLOG.md и SNAPSHOT.md после каждой фазы
...
- [ ] SNAPSHOT.md — модуль добавлен в структуру
...
```markdown
1. Обновить метафайлы (см. CLAUDE.md):
   - BACKLOG.md
   - SNAPSHOT.md
   - CLAUDE.md
...
- ✅ Обновлять SNAPSHOT.md после каждой фазы
...
- **SNAPSHOT.md** — обновляется после каждой фазы
- **ARCHITECTURE.md** — определяет структуру модулей
- **CLAUDE.md** — процесс обновления документации
...
5. **Следуй плану** и обновляй SNAPSHOT.md после каждой фазы
